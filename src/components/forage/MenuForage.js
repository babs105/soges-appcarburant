...
function MenuForage() {
  return (
    <div
      className=" d-sm-flex justify-content-start align-items-center d-lg-block c-menu-height col-12 col-lg-2 bg-c-light border-right border-bottom  p-1 p-lg-4 "
      // style={{ height: "100vh" }}
    >
