...
function RavitaillementByCuveInPreviousMonth() {
  const { ravitaillementCuvePreviousMonth } = useContext(DashbordContext);
            ...
            <table className="table  ">
              ...
              <tbody>
                {logging ? (
                  ...
                  ravitaillementCuvePreviousMonth.map((data) => (
                    <tr key={i++}>
...
export default RavitaillementByCuveInPreviousMonth;
