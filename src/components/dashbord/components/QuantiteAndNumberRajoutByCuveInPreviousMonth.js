...
function QuantiteAndNumberRajoutByCuveInPreviousMonth() {
  const { rajoutByCuvePreviousMonth } = useContext(DashbordContext);
            ...
            <table className="table">
              ...
              <tbody>
                {logging ? (
                  ...
                  rajoutByCuvePreviousMonth.map((data) => (
                    <tr key={i++}>
...
export default QuantiteAndNumberRajoutByCuveInPreviousMonth;
