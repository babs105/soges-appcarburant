...
function QuantiteFuelAndNumberInCurrentMonthByVehicule() {
            ...
            <table className="table  ">
              ...
              <tbody>
                {logging ? (
                  ...
                  ravitaillementVehiculeCurrentMonth.map((data) => (
                    <tr key={i++}>
...
export default QuantiteFuelAndNumberInCurrentMonthByVehicule;
