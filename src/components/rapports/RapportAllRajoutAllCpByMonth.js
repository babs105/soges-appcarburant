...
function RapportAllRajoutAllCpByMonth({
  rajoutsByMonth,
  logging,
  search,
  title,
  ...
  useEffect(() => {
    ...
    console.log("les rajouts", rajoutsByMonth);

    const newData = search([...rajoutsByMonth]);
    setExportData(newData);
    console.log(" liste cuve principale", rajoutsByMonth);
  ...
  }, [pagination.numberPerPage, pagination.offset, rajoutsByMonth, search]);
...
export default RapportAllRajoutAllCpByMonth;
