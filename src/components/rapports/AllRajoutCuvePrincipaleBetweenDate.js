...
function AllRajoutCuvePrincipaleBetweenDate({
  rajoutsBetweenDate,
  logging,
  search,
  title,
  ...
  useEffect(() => {
    ...
    console.log("les rajouts", rajoutsBetweenDate);

    const newData = search([...rajoutsBetweenDate]);
    setExportData(newData);
    console.log(" liste cuve principale", rajoutsBetweenDate);
  ...
  }, [pagination.numberPerPage, pagination.offset, rajoutsBetweenDate, search]);
...
export default AllRajoutCuvePrincipaleBetweenDate;
