...
function createCuve(cuve) {
  ...
  return axios
    .post("/cuve/create", cuve)
    .then(handleRegisterResponse)
    .then((cuve) => cuve);
}
function getAllCuves() {
  return axios
    .get("/cuve/getAllCuves")
    .then(handleRegisterResponse)
    .then((cuve) => cuve);
}
function getCuveByIdCuve(idCuve) {
  return axios
    .get("/cuve/getCuveByIdCuve/" + idCuve)
    .then(handleRegisterResponse)
    .then((cuve) => cuve);
}
function getCuveById(cuveId) {
  return axios
    .get("/cuve/getCuveById/" + cuveId)
    .then(handleRegisterResponse)
    .then((cuve) => cuve);
}
function getCuveByCuveName(cuveName) {
  return axios
    .get("/cuve/getCuveByCuveName/" + cuveName)
    .then(handleRegisterResponse)
    .then((cuve) => cuve);
}
function deleteCuveByCuveName(cuveName) {
  return axios
    .delete("/cuve/deleteCuveByCuveName/" + cuveName)
    .then(handleRegisterResponse)
    .then((cuve) => cuve);
}
function updateCuve(data) {
  return axios
    .put("/cuve/update", data)
    .then(handleRegisterResponse)
    .then((cuve) => cuve);
}
